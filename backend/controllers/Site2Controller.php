...
//       $value->MobileNo=$mob;
//        if ($value->save()) {
//            return $this->redirect(['changemobile']);
//         } 
//       }
//     }else{
...
//         return $this->render('agentmobile');
...
// -------------------------------------------Agent Payment Details ----------------------------------------------------
    ...
    //   if (isset(Yii::$app->request->post()['search'])) {
    //       $lnacno = Yii::$app->request->post('loanacno');
    //       $getpayment = TXNDETAILS::find()->where(['LOAN_ID'=>$lnacno,'TXN_STATUS'=>1])->orderBy(['TXN_DATE'=>SORT_DESC])->all();
    //    }
    //   return $this->render('agentdetails',['getpayment'=>$getpayment]);
    // }
