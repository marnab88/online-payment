						...
						foreach ($details as $key => $value) {
							...
							<tr>
								...
								<td><a href="<?php 
								 ...
								 echo Url::toRoute(['site/both','id' => $value->RecordId,'type'=>34]);}
								 elseif(Yii::$app->user->identity->Type == "MFI"){
								 echo Url::toRoute(['site/mfi','id' => $value->RecordId,'type'=>34]);}
								 elseif(Yii::$app->user->identity->Type == "MSME"){
								 echo Url::toRoute(['site/msme','id' => $value->RecordId,'type'=>34]);}
								 else{
								 	echo Url::toRoute(['site/both','id' => $value->RecordId,'type'=>34]);
								 }
