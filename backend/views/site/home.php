			...
			<div class="col-lg-7 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<?php $form = ActiveForm::begin(['options' => ['class' => 'forms-sample', 'enctype' => 'multipart/form-data', 'accept' => ".xls,.xlsx"], 'validateOnSubmit' => true, 'validateOnChange' => false, 'validateOnBlur' => false, 'validateOnType' => false]) ?>
											...
											<td>
												<span style="color:#00CC00">
													...
													<?php } else if ($details->Status != 1) { ?>
														<?php echo "Processing"; ?>
													<?php } else {
														echo $details->Count - ($details->Mismatch + $details->MobileCount);
													} ?>
...
<?php
$printUrl = Url::toRoute(['site/ajaxrelaodetails']);
$js = <<<JS
setInterval( function () {
	$('#tabledetails').load("$printUrl");
}, 5000 );
JS;
$this->registerJs($js);
?>