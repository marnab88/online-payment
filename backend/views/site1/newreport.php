      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-sm-6 text-right">
            <a href="<?= Url::toRoute(['site1/newreport','export' => 'yes']);  ?>" class="btn btn-success">Export Report</a>
          ...
          <table class="table table-striped table-bordered" id="table_emp">
            ...
            <tbody>
              ...
              <td><?= date('M-Y', strtotime($value->DemandDate)) ?></td>	
            	...
            	<td>
                <a href="<?= Url::toRoute(['site1/customerdetails','branch' => $value->BranchName,'fromdt' =>$fromdate,'todt' =>$todate,'pagination'=>'true']);  ?>"><?= $value->totalcustomer ?></a>
              </td>
