						...
						if ($alldetails) {
                            ...
                            foreach($alldetails as $details)
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php
                                    if(Yii::$app->user->identity->Type == "MFI"){
                                     echo Url::toRoute(['site2/mfi','id' => $details->RecordId,'mon'=>$details->MonthYear,'type' =>35,'pagination'=>'show']);}
                                     elseif(Yii::$app->user->identity->Type == "MSME"){
                                     echo Url::toRoute(['site2/msme','id' => $details->RecordId,'mon'=>$details->MonthYear,'type' =>35,'pagination'=>'show']);}
                                     else{
                                        echo Url::toRoute(['site2/both','id' => $details->RecordId,'mon'=>$details->MonthYear,'type' =>35,'pagination'=>'show']);
                                     }							 
