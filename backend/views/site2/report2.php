      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-sm-6 text-right">
                <a href="<?= Url::toRoute(['site2/report2','export' => 'yes']);  ?>" class="btn btn-success">Export Report</a>
            </div>
          ...
          <table class="table table-striped table-bordered" id="table_emp">
            ...
            <tbody>
              ...
              <td>
                <a href="<?= Url::toRoute(['site2/cust-payment','branch' => $value->BranchName,'fromdt' =>$fromdate,'todt' =>$todate,'pagination'=>'true']);  ?>"><?= $value->totalcustomer ?></a>
              </td>
