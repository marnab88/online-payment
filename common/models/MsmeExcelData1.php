 ...
 */
class MsmeExcelData1 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function getPaymentstatus()
    {
     ...
     public function getCountcustomerpaid($RecordId,$BranchName)
    {
       $cnt=$this->find()->joinWith('paymentstatus')->andWhere(['MsmeExcelData.RecordId'=>$RecordId,'BranchName'=>$BranchName])->select('sum(TXN_DETAILS.TXN_AMT) as amountcollected, count(TXN_DETAILS.id) as customerpaid')->one();
       echo $cnt->amountcollected;
       echo $cnt->customerpaid;
       return $cnt;
    }
}
